...
def load_dataset(client_id: int):
    df = pd.read_csv('C:/Users/markd/Desktop/SVM Experiments/Random Forest/EncodedExperimental.csv')
...
# Look at the Isolation Forest documentation of sklearn and select the parameters
# Get the parameters from the Isolation Forest
...
# Set the parameters in the Isolation Forest
